...
MAPS = {
    ...
    "remove_links": build_line_with_substring_remover(["https:", "http:"]),
...
def main():
    ...
    if args.load_arrow_file:
        ...
        ds = load_dataset("json", data_files=args.dataset_path, split="train") #, use_auth_token=True, ignore_verifications=True)
